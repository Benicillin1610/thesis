...
from transformers import (
    AutoModel, LongformerTokenizer, DataCollatorWithPadding, 
    LongformerForSequenceClassification, TrainingArguments, Trainer, TrainerCallback
)
...
#_single_10W_5hours_restored.txt

# Use the Longformer model
name = "allenai/longformer-base-4096"
matrix_name="confusion_matrix_longformer_500_new4.png"
loss_epoch="loss_comparison_epoch_longformer_500_new4.png"
accuracy_epoch="accuracy_epoch_longformer_500_new4.png"
output_dir = "longformersleep_500_new4"
...
tokenizer = LongformerTokenizer.from_pretrained(name)

special_tokens_dict = {'additional_special_tokens': ['N1', 'N2', 'N3', 'R', 'W']}
